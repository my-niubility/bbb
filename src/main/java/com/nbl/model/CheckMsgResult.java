...
public class CheckMsgResult {
    ...
    private String frCheckStatus;

    private String msgType;

    private String dealStatus;

    private String laCheckStatus;
    ...
    public String getFrCheckStatus() {
        return frCheckStatus;
    }

    public void setFrCheckStatus(String frCheckStatus) {
        this.frCheckStatus = frCheckStatus == null ? null : frCheckStatus.trim();
    }
    ...
    public String getLaCheckStatus() {
        return laCheckStatus;
    }

    public void setLaCheckStatus(String laCheckStatus) {
        this.laCheckStatus = laCheckStatus == null ? null : laCheckStatus.trim();
    }
}